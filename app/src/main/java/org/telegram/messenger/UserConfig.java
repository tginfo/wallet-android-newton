...
public class UserConfig extends BaseController {
    ...
    public void loadConfig() {
        synchronized (sync) {
            ...
            walletConfigUrl[NETWORK_TYPE_TEST] = preferences.getString("walletConfigUrl", "https://newton-blockchain.github.io/newton-test.global.config.json");
            walletConfigType[NETWORK_TYPE_TEST] = preferences.getInt("walletConfigType", TonController.CONFIG_TYPE_URL);
            walletBlockchainName[NETWORK_TYPE_TEST] = preferences.getString("walletBlockchainName", "Newton");
